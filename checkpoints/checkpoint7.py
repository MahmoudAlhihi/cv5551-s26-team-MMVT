from checkpoints.checkpoint6 import get_transform_cube
...
from checkpoints.checkpoint1 import grasp_cube, GRIPPER_LENGTH
from checkpoints.checkpoint2 import place_in_basket, BASKET_POSE
