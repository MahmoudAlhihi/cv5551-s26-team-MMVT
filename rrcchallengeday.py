...
def build_full_mask(image: numpy.ndarray):

    mask_red = get_sam3_mask(image, color='red')
    mask_green = get_sam3_mask(image, color='green')
    mask_blue = get_sam3_mask(image, color='blue')
